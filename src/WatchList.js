...
export default function WatchList({ toWatchList, clearToWatch, addNewToWatch, removeFromWatchList, markAsWatched, onToWatchList, onWatchedList, unMarkAsWatched, editItem, removeSelectedFromWatchList}) {
  ...
  return (
    ...
    <h1>Watchlist</h1>
      ...
      <button className='btn btn-mark-as-watched-selected'>mark as watched selected</button>
